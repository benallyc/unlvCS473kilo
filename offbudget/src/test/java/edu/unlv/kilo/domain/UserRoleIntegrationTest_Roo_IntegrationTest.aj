...
import edu.unlv.kilo.domain.UserRoleDataOnDemand;
...
privileged aspect UserRoleIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserRoleIntegrationTest.testCountUserRoles() {
        ...
        long count = edu.unlv.kilo.domain.UserRole.countUserRoles();
    ...
    public void UserRoleIntegrationTest.testFindUserRole() {
        edu.unlv.kilo.domain.UserRole obj = dod.getRandomUserRole();
        ...
        obj = edu.unlv.kilo.domain.UserRole.findUserRole(id);
    ...
    public void UserRoleIntegrationTest.testFindAllUserRoles() {
        ...
        java.util.List<edu.unlv.kilo.domain.UserRole> result = edu.unlv.kilo.domain.UserRole.findAllUserRoles();
    ...
    public void UserRoleIntegrationTest.testFindUserRoleEntries() {
        ...
        java.util.List<edu.unlv.kilo.domain.UserRole> result = edu.unlv.kilo.domain.UserRole.findUserRoleEntries(0, (int) count);
    ...
    public void UserRoleIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUserRole(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        edu.unlv.kilo.domain.UserRole merged =  obj.merge();
        obj.flush();
    ...
    public void UserRoleIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'UserRole' failed to initialize correctly", dod.getRandomUserRole());
        edu.unlv.kilo.domain.UserRole obj = dod.getNewTransientUserRole(Integer.MAX_VALUE);
    ...
    public void UserRoleIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'UserRole' with identifier '" + id + "'", edu.unlv.kilo.domain.UserRole.findUserRole(id));
    }
