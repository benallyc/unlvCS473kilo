...
import edu.unlv.kilo.domain.UserDataOnDemand;
...
privileged aspect UserIntegrationTest_Roo_IntegrationTest {
    ...
    public void UserIntegrationTest.testCountUsers() {
        ...
        long count = edu.unlv.kilo.domain.User.countUsers();
    ...
    public void UserIntegrationTest.testFindUser() {
        edu.unlv.kilo.domain.User obj = dod.getRandomUser();
        ...
        obj = edu.unlv.kilo.domain.User.findUser(id);
    ...
    public void UserIntegrationTest.testFindAllUsers() {
        ...
        java.util.List<edu.unlv.kilo.domain.User> result = edu.unlv.kilo.domain.User.findAllUsers();
    ...
    public void UserIntegrationTest.testFindUserEntries() {
        ...
        java.util.List<edu.unlv.kilo.domain.User> result = edu.unlv.kilo.domain.User.findUserEntries(0, (int) count);
    ...
    public void UserIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyUser(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        edu.unlv.kilo.domain.User merged =  obj.merge();
        obj.flush();
    ...
    public void UserIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'User' failed to initialize correctly", dod.getRandomUser());
        edu.unlv.kilo.domain.User obj = dod.getNewTransientUser(Integer.MAX_VALUE);
    ...
    public void UserIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'User' with identifier '" + id + "'", edu.unlv.kilo.domain.User.findUser(id));
    }
